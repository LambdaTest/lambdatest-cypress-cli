module.exports = {
  ...
  beta: {
    INTEGRATION_BASE_URL: "https://api-cypdevenv24-dev.lambdatestinternal.com/liis",
    BUILD_BASE_URL:
      "https://api-cypdevenv24-dev.lambdatestinternal.com/automation/api/v1/builds/",
    BUILD_STOP_URL:
      "https://api-cypdevenv24-dev.lambdatestinternal.com/api/v1/test/stop?sessionId=",
    SESSION_URL:
      "https://api-cypdevenv24-dev.lambdatestinternal.com/automation/api/v1/sessions?limit=200&session_id=",
    REPORT_URL:
      "https://api-cypdevenv24-dev.lambdatestinternal.com/automation/api/v1/cypress/artefacts/test/",
  },
